...
- `user-journeys.md` — end-to-end journeys
- `information-architecture.md` — navigation and screen roles
- `screen-state-spec.md` — state machines and interaction behavior
- `graph-interaction-spec.md` — graph layout/rendering/semantic zoom rules
